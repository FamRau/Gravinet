...
const TRANSLATIONS = {
  de: {
    ...
    settings_cat_appearance: 'Darstellung', settings_cat_contacts: 'Kontakte', settings_cat_language: 'Sprache', settings_cat_todoist: 'Todoist',
    todoist_username: 'Benutzername', todoist_token: 'API Token', todoist_token_ph: 'Token eingeben…',
    todoist_sync_mode: 'Synchronisierung', todoist_sync_none: 'Keine Synchronisierung',
    todoist_sync_start: 'Beim Start', todoist_sync_30min: 'Alle 30 Minuten', todoist_sync_1hour: 'Jede Stunde',
    todoist_sync_now: 'Jetzt synchronisieren', todoist_syncing: 'Synchronisiert…',
    todoist_sync_ok: 'Synchronisierung erfolgreich', todoist_sync_err: 'Fehler bei Synchronisierung',
    todoist_token_saved: 'Token gespeichert', todoist_desc: 'Aufgaben mit Todoist synchronisieren.',
    todoist_username_ph: 'Benutzername…',
    todoist_project: 'Todoist Projekt', todoist_project_loading: 'Projekte werden geladen…',
    todoist_project_inbox: 'Posteingang (Standard)', todoist_project_none: '— Projekt wählen —',
    todoist_import_target: 'Import-Ziel (neue Todoist-Aufgaben)', todoist_import_desc: 'Neue Todoist-Aufgaben werden diesem Kontakt zugewiesen.',
    todoist_import_none: '— Kein Import —', todoist_import_proj: 'Gravinet-Projekt',
    settings_theme: 'Thema', settings_theme_dark: '🌙 Dunkel', settings_theme_light: '☀ Hell',
    settings_interval: 'Standard Kontakt-Intervall', settings_interval_desc: 'Nach wie vielen Tagen wird ein Stakeholder als "überfällig" markiert.',
    settings_lang: 'Sprache', settings_lang_de: 'Deutsch', settings_lang_en: 'English',
    settings_lang_desc: 'Anzeigesprache der Benutzeroberfläche.',
    // Stats
    ...
    confirm_delete_journal: 'Journaleintrag löschen?',
    journal_type: 'Typ',
    ...
    aufgaben_th_reminder: '🔔 Erinnerung', aufgaben_th_interval: 'Wiederholung', aufgaben_th_tag: 'Tag', aufgaben_th_notes: 'Notiz',
  ...
  en: {
    ...
    settings_cat_appearance: 'Appearance', settings_cat_contacts: 'Contacts', settings_cat_language: 'Language', settings_cat_todoist: 'Todoist',
    todoist_username: 'Username', todoist_token: 'API Token', todoist_token_ph: 'Enter token…',
    todoist_sync_mode: 'Synchronisation', todoist_sync_none: 'No sync',
    todoist_sync_start: 'On startup', todoist_sync_30min: 'Every 30 minutes', todoist_sync_1hour: 'Every hour',
    todoist_sync_now: 'Sync now', todoist_syncing: 'Syncing…',
    todoist_sync_ok: 'Sync successful', todoist_sync_err: 'Sync error',
    todoist_token_saved: 'Token saved', todoist_desc: 'Synchronise tasks with Todoist.',
    todoist_username_ph: 'Username…',
    todoist_project: 'Todoist Project', todoist_project_loading: 'Loading projects…',
    todoist_project_inbox: 'Inbox (Default)', todoist_project_none: '— Select project —',
    todoist_import_target: 'Import target (new Todoist tasks)', todoist_import_desc: 'New Todoist tasks will be assigned to this contact.',
    todoist_import_none: '— No import —', todoist_import_proj: 'Gravinet project',
    settings_theme: 'Theme', settings_theme_dark: '🌙 Dark', settings_theme_light: '☀ Light',
    settings_interval: 'Default Contact Interval', settings_interval_desc: 'After how many days a stakeholder is marked as "overdue".',
    settings_lang: 'Language', settings_lang_de: 'Deutsch', settings_lang_en: 'English',
    settings_lang_desc: 'Display language of the user interface.',
    // Stats
    ...
    confirm_delete_journal: 'Delete journal entry?',
    journal_type: 'Type',
    ...
    aufgaben_th_reminder: '🔔 Reminder', aufgaben_th_interval: 'Repeat', aufgaben_th_tag: 'Tag', aufgaben_th_notes: 'Notes',
